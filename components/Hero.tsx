      ...
      <div className="container-custom relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-pearl/80 mb-12 max-w-3xl mx-auto leading-relaxed"
          >
          ...
          >
            {[
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-pearl mb-2">{feature.title}</h3>
                <p className="text-pearl/70">{feature.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
