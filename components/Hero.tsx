  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-charcoal pb-safe pt-24 sm:pt-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start items-center mb-8 sm:mb-12"
            >
            ...
            >
              ...
              >
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold font-accent" style={{ color: '#4ADE80' }}>$12M+</div>
              ...
              <motion.div
                ...
                className="glass-dark px-4 py-3 sm:px-6 sm:py-4 rounded-xl border border-white/10 flex-1 min-w-[140px] sm:flex-none"
              >
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold font-accent" style={{ color: '#60A5FA' }}>480%</div>
              ...
              <motion.div
                ...
                className="glass-dark px-4 py-3 sm:px-6 sm:py-4 rounded-xl border border-white/10 flex-1 min-w-[140px] sm:flex-none"
              >
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold font-accent" style={{ color: '#F59E0B' }}>100+</div>
                <div style={{ color: 'rgba(234, 230, 224, 0.9)' }} className="text-xs sm:text-sm">B2B Companies</div>
              </motion.div>
            </motion.div>
          </div>
      ...
      <motion.div
        ...
        className="absolute bottom-12 md:bottom-8 left-1/2 transform -translate-x-1/2 pb-safe"
      >
        <motion.div
          animate={{ y: [0, 10, 0] }}
